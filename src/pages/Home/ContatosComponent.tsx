...
export default function ContatosSection({ ...props }) {
  const linkZap = "https://wa.me/5598987132829";
  const linkGit = "https://github.com/polarisid";
  const linkLinkedin = "https://www.linkedin.com/in/danielcarvalhoribeiro/";
  const linkEmail = "mailto:danielcarvalhorst@gmail.com";
  return (
    <>
      <ContatosStyled>
        ...
        <div className="listOfContacts">
          <Fade cascade damping={0.1}>
            ...
            <div className="contact">
              <a href={linkEmail} target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
...
const ContatosStyled = styled.div`
  .listOfContacts {
    margin-bottom: 10px;
    display: grid;
